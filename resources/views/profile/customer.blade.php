    ...
    <div class="row p-0 m-0">
        <div class="col-lg-10 p-0 m-0">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-3">
                        <form class="category-filter float-left fixed-left p-3 my-2 rounded" method="GET">
                            <div class="for mt-3">
                                <li>For:
                                    <ul>
                                        ...
                                        <li>
                                            <label for="cat{{ $cat->id }}">
                                                <input class="cat" type="checkbox" name="categories[{{ $cat->id }}]"
                                                    id="cat{{ $cat->id }}" value="{{ $cat->id }}" @if(in_array($cat->id,
                                                $cats)) checked @endif >
                                                {{ $cat->name }}
                                            </label>
                                            @if($cat->types->count())
                                                ...
                                                <li>
                                                    <label for="type{{ $type->id }}">
                                                        <input class="type" type="checkbox"
                                                            name="types[{{ $type->id }}]" id="type{{ $type->id }}"
                                                            value="{{ $type->id }}" @if(in_array($type->id, $types))
                                                        checked @endif >
                                                        {{ $type->name }}
                                    ...
                                    <ul>
                                        <li>
                                            <label for="filter-small">
                                                <input type="checkbox" @if(isset($_GET["s"])) checked @endif name="s"
                                                    id="filter-small">Small</li>
                                        </label>
                                        <li>
                                            <label for="filter-medium">
                                                <input type="checkbox" @if(isset($_GET["m"])) checked @endif name="m"
                                                    id="filter-medium">Medium</li>
                                        </label>
                                        <li>
                                            <label for="filter-large">
                                                <input type="checkbox" @if(isset($_GET["l"])) checked @endif name="l"
                                                    id="filter-large">Large</li>
                                        </label>
                                        <li>
                                            <label for="filter-xlarge">
                                                <input type="checkbox" @if(isset($_GET["xl"])) checked @endif name="xl"
                                                    id="filter-xlarge">X-large</li>
                                        </label>
                                        <li>
                                            <label for="filter-xxlarge">
                                                <input type="checkbox" @if(isset($_GET["xxl"])) checked @endif
                                                    name="xxl" id="filter-xxlarge">XX-large</li>
                                        </label>
                                        <li>
                                            <label for="filter-more">
                                                <input type="checkbox" @if(isset($_GET["more"])) checked @endif
                                                    name="more" id="filter-more">More</li>
                                        </label>
                                    </ul>
                                </li>
                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="buttons m-3 d-flex justify-content-center">
                                    <div>
                                        <a href="{{ route("order.show") }}" class="btn btn-info py-2 px-3 m-3">My
                                            Orders</a>
                                        <a href="{{ route("request.customer") }}" class="btn btn-info py-2 px-3 m-3">My
                                            Requests</a>
                                    </div>
                                    <div>
                                        <a href="{{ route("request.create") }}"
                                            class="btn btn-info py-2 px-3 m-3">Create New Request</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Add to cart Modal -->
<div class="modal addcart-modal w-100 fade" id="add-cart" tabindex="-1" role="dialog"
        ...
        <div class="modal-content p-5">
            ...
            <form>
                <div class="my-4 col-md-12">
                    ...
                    <div class="form-check d-inline ml-3">
                        <input class="form-check-input xxlarge-check" name="size" type="checkbox" value=""
                            id="xx-large">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input class="color-check-input red-check" name="size" type="checkbox"
                                                value="" id="small-red">
                                            <lable class="pb-3" for="small-color-num"><button class="colorRed"></button>
                                            </lable>
                                            <input class="color-check-input blue-check" name="size" type="checkbox"
                                                value="" id="small-blue">
                                            <button class="colorBlue"></button>
                                            <input class="color-check-input black-check" name="size" type="checkbox"
                                                value="" id="small-black">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-6 small-red-num">
                                                    ...
                                                    <select class="form-control color-number" type="number"
                                                        id="small-red-num">
                                                        <option>1</option>
                                                        <option>2</option>
                                                        <option>3</option>
                        ...
                        <div class="col-md-6 pb-3">
                            <div class="medium-info">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="medium-word">
                                                <h5>Medium: </h5>
                                            </div>
                                            <input class="color-check-input red-check" name="size" type="checkbox"
                                                value="" id="medium-red">
                                            <lable class="pb-3" for="medium-color-num"><button
                                                    class="colorRed"></button>
                                            </lable>
                                            <input class="color-check-input blue-check" name="size" type="checkbox"
                                                value="" id="medium-blue">
                                            <button class="colorBlue"></button>
                                            <input class="color-check-input black-check" name="size" type="checkbox"
                                                value="" id="medium-black">
                                            <button class="colorBlack"></button>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
                        ...
                        <div class="col-md-6 pb-3">
                            <div class="xlarge-info">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="xlarge-word">
                                                <h5>X-large: </h5>
                                            </div>
                                            <input class="color-check-input red-check" name="size" type="checkbox"
                                                value="" id="xlarge-red">
                                            <lable class="pb-3" for="xlarge-color-num"><button
                                                    class="colorRed"></button>
                                            </lable>
                                            <input class="color-check-input blue-check" name="size" type="checkbox"
                                                value="" id="xlarge-blue">
                                            <button class="colorBlue"></button>
                                            <input class="color-check-input black-check" name="size" type="checkbox"
                                                value="" id="xlarge-black">
                                            <button class="colorBlack"></button>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
                        ...
                        <div class="col-md-6 pb-3">
                            <div class="xxlarge-info">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="xxlarge-word">
                                                <h5>XX-large: </h5>
                                            </div>
                                            <input class="color-check-input red-check" name="size" type="checkbox"
                                                value="" id="xxlarge-red">
                                            <lable class="pb-3" for="xxlarge-color-num"><button
                                                    class="colorRed"></button>
                                            </lable>
                                            <input class="color-check-input blue-check" name="size" type="checkbox"
                                                value="" id="xxlarge-blue">
                                            <button class="colorBlue"></button>
                                            <input class="color-check-input black-check" name="size" type="checkbox"
                                                value="" id="xxlarge-black">
                                            <button class="colorBlack"></button>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
